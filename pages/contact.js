      ...
      >
        ...
        >
          <input
            type="text"
            name="name"
            className="w-full px-2 py-[12px] mb-4 rounded-md outline-none bg-[#0F172A]/70 border border-slate-700/50 text-[#E2E8F0] placeholder-[#64748B] focus:border-[#38BDF8] focus:ring-1 focus:ring-[#38BDF8] transition"
          ...
          <textarea
            ...
            rows="5"
            name="message"
            className="w-full h-full resize-none rounded-md outline-none px-2 py-2 mb-3 bg-[#0F172A]/70 border border-slate-700/50 text-[#E2E8F0] placeholder-[#64748B] focus:border-[#38BDF8] focus:ring-1 focus:ring-[#38BDF8] transition"
            placeholder="Message"
            onChange={handleInput}
            value={userInput.message}
          ></textarea>
          <button
            className="w-full px-2 py-3 text-center rounded-md bg-[#22C55E] text-[#0F172A] font-semibold hover:bg-[#38BDF8] hover:text-white transition duration-300"
            onClick={sendMessage}
          >
            {loading ? (
